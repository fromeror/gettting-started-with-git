...
You can add _emphasis_ to text by wrapping the text in single asterisks or underscores, and you can **bold** text by adding two asterisks or underscores on either side of the bolded text.
